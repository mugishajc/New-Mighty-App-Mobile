...
public class USSDController implements africa.delasoft.mighty.lib.USSDInterface, USSDApi {
    ...
    protected USSDController.CallbackInvoke callbackInvoke;

    protected USSDController.CallbackMessage callbackMessage;
     ...
     */
    public void callUSSDInvoke(String ussdPhoneNumber, HashMap<String, HashSet<String>> map, USSDController.CallbackInvoke callbackInvoke) {
     ...
     * @param callbackInvoke  a callback object from return answer
     */
    public void callUSSDOverlayInvoke(String ussdPhoneNumber, HashMap<String, HashSet<String>> map, USSDController.CallbackInvoke callbackInvoke) {
    ...
    public void callUSSDInvoke(String ussdPhoneNumber, int simSlot, HashMap<String, HashSet<String>> map, USSDController.CallbackInvoke callbackInvoke) {
     ...
     */
    @SuppressLint("MissingPermission")
    public void callUSSDOverlayInvoke(String ussdPhoneNumber, int simSlot, HashMap<String, HashSet<String>> map, USSDController.CallbackInvoke callbackInvoke) {
        this.callbackInvoke = callbackInvoke;
        this.map = map;
    ...
    public void send(String text, USSDController.CallbackMessage callbackMessage) {
