    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        if (LoginView(event) && notInputText(event)) {
            ...
            if (notInputText(event)) {
                ...
                // sent option 1
                if (africa.delasoft.mighty.lib.USSDController.instance.callbackMessage == null)
                    africa.delasoft.mighty.lib.USSDController.instance.callbackInvoke.responseInvoke(response);
                else {
                    africa.delasoft.mighty.lib.USSDController.instance.callbackMessage.responseMessage(response);
